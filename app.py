...
class List_diploms(db.Model):
    ...
    name_diplom = db.Column(db.String(100), nullable=False)
...
def course(id):
    ...
    #print(groups)
    students = studweb.query.order_by(studweb.id.asc()).all()
    #for el in students:
        #print(el.course)
...
def students_web(id):
    try:
        ...
        return render_template("student_page.html", student=student, programm_sentences=programm_sentences,
